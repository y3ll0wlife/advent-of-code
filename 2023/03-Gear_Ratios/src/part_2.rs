    ...
    for (y, row) in schematic.iter().enumerate() {
        for (x, c) in row.iter().enumerate() {
            ...
            if top_left.is_digit && top.is_digit && top_right.is_digit {
                values.push(get_full_number(top_left.x, &schematic[top_left.y]));
            } else if top_left.is_digit && top.is_digit {
                values.push(get_full_number(top_left.x, &schematic[top_left.y]));
            } else if top_right.is_digit && top.is_digit {
                values.push(get_full_number(top_right.x, &schematic[top_right.y]));
            }
            ...
            if top.is_digit && !top_left.is_digit && !top_right.is_digit {
                values.push(get_full_number(top.x, &schematic[top.y]));
            }
            ...
            if bottom_left.is_digit && bottom.is_digit && bottom_right.is_digit {
                values.push(get_full_number(bottom_left.x, &schematic[bottom_left.y]));
            } else if bottom_left.is_digit && bottom.is_digit {
                values.push(get_full_number(bottom_left.x, &schematic[bottom_left.y]));
            } else if bottom_right.is_digit && bottom.is_digit {
                values.push(get_full_number(bottom_right.x, &schematic[bottom_right.y]));
            }
            ...
            if bottom.is_digit && !bottom_left.is_digit && !bottom_right.is_digit {
                values.push(get_full_number(bottom.x, &schematic[bottom.y]));
            }
            ...
            if left.is_digit {
                values.push(get_full_number(left.x, &schematic[left.y]));
            }

            if right.is_digit {
                values.push(get_full_number(right.x, &schematic[right.y]));
            }
